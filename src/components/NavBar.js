    ...
    return(
        <nav className='navBar'>
            ...
            <ul className='navBar-container'>
                ...
                <li className='nav-item'><NavLink to='/rental/' className='nav-menu'>기기 대여</NavLink></li>
                <li className='nav-item'><NavLink to='/donation/' className='nav-menu'>기기 기부</NavLink></li>
            </ul>
