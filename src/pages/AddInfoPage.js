    ...
    return(
        <AddInfoContainer>
            ...
            <InputContainer>
                ...
                <InputText>
                    어떤 목적으로 사이트를 찾아오셨나요?<br/>
                    학생인지 보호자인지에 따라 이용할 수 있는 서비스가 달라지므로 정확하게 선택해 주세요.
                </InputText>
                <ButtonContainer>
                    <SelectBtn onClick={handleBtnColor} color={student}>학생</SelectBtn>
                    <SelectBtn2 onClick={handleBtnColor2} color={nursingHome}>요양원</SelectBtn2>
                    {student ? <ConferText color={'#D88E00'}>※ 현재 고등학교 재학 중인 학생으로, 노인 디지털 교육을 제공하고<br/>포인트를 쌓아 스마트폰을 대여하려고 합니다.</ConferText>
                    : <ConferText color={'#3A55B5'}>※ 노인 복지시설 관리자로서,<br/>어르신을 위한 디지털 기기 교육 프로그램을 등록하려고 합니다.</ConferText>}
                </ButtonContainer>
