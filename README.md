...
## ✅ 배운 점 & 아쉬운 점
- 아무래도 처음 경험한 프로젝트이다 보니, 브랜치 관련 전략도 사용하지 못했고 주석이나 커밋, 개발 및 트러블 슈팅 기록을 남기지 못했던 점이 아쉬웠습니다. 프로젝트가 끝나고 나니 아쉬웠던 점이 눈에 보이지만 해당 프로젝트에서 부족했던 것들을 다음 프로젝트에서는 꽉꽉 채울 수 있도록 해야겠습니다. 💪🏻🔥
